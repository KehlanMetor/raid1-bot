...
const botPrefix = "*"
  ...
  client.user.setActivity("accroupissez vous bande de salope !", {
    type: "STREAMING",
...
client.on('message',  msg => {
    ...
    if(msg.content == "*1help"){
      ...
      .addField("` ESA#0959 n'est pas responsables de ce que vous en faites!", 'Utilisation à vos risques et périls!')
      .addField('Commandes', 
...
//Commande fake 
    if(msg.content == "*help"){
      ...
      .setURL('https://github.com/KehlanMetor')
